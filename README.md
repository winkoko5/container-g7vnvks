...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-g7vnvks.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-g7vnvks.containers.anotherwebservice.com/
...
```
git clone git@github.com:winkoko5/container-g7vnvks.git
cd container-g7vnvks
```
...
```
docker attach container-g7vnvks
```
